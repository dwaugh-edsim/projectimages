...
function initTopics() {
  var topics = [
    {id: '1', title: 'Economic Hostage? Trump & the 51st State', curr: 'SCO 4.1', desc: 'Imagine a world where the U.S. treats Canada like a suburb. Align or starve.', ex: 'The Tariff Wall: A 25% tax on everything. * Energy Surrender: Canada as the U.S. gas station.', img: 'topic_1_trump_51st_state_1777300259320.png'},
    {id: '2', title: 'Is AI Killing the Future? The Great Gamble', curr: 'SCO 5.3', desc: 'Job losses, power-hungry servers, and the end of privacy. Is AI our savior or our doom?', ex: 'The Jobless Class: AI replacing 40% of professional roles. * The Power Crunch: Restarting coal plants to feed data centers.', img: 'topic_3_post_work_ai_1777300282114.png'},
    {id: '3', title: 'The Housing Trap: Locked Out', curr: 'SCO 5.1', desc: 'The Canadian Dream is a ghost story. Rents are so high you might never move out.', ex: 'The Rent-Pocalypse: $2,800 for a basement in Halifax. * Institutional Landlords: Billionaires buying entire subdivisions.', img: 'topic_4_housing_crisis_1777300294903.png'},
    {id: '4', title: 'The Trade Wall: Internal Sabotage', curr: 'SCO 4.1', desc: 'It’s harder to sell beer to New Brunswick than to the USA. Provincial bickering costs us billions.', ex: 'The Certification Friction: A nurse forced to retrain just to move provinces. * The Alcohol Embargo: Sting operations at provincial borders.', img: 'topic_6_trade_barriers_1777300330383.png'},
    {id: '5', title: 'The Immigration Pivot: Slamming the Brakes', curr: 'SCO 4.5', desc: 'Canada shut the door to save housing. Now, the farms are rotting and the nursing homes are empty.', ex: 'The Farm Crisis: $50M in fruit rotting in the Okanagan. * The Wage Spike: $25/hour burgers because no one is left to hire.', img: 'topic_9_immigration_labor_1777300375370.png'},
    {id: '6', title: 'The EV Tariff War: Made in Canada?', curr: 'SCO 4.1', desc: 'China built a $15k EV. We taxed it 100% to save our $60k gas-guzzlers.', ex: 'The BYD Shutdown: Banning cheap cars to save expensive ones. * The Legacy Tax: Paying an extra $30k for an EV just to keep a factory open.', img: 'topic_10_chinese_evs_1777300457055.png'},
    {id: '7', title: 'End of the Sale: Algorithmic Pricing', curr: 'SCO 5.3', desc: 'Price tags are now digital screens that change while you walk by. Welcome to the war for your wallet.', ex: 'The Uber Model for Bread: Prices spiking at 5:00 PM. * Personalized Pricing: Seeing higher prices if the app thinks you’re wealthy.', img: 'topic_11_algorithmic_pricing_1777300469470.png'},
    {id: '8', title: 'The Boomer Inheritance: Luck of the Draw', curr: 'SCO 5.1', desc: 'Trillions are moving from Boomers to their kids. If your parents own a house, you’re set. If not, you’re stuck.', ex: 'The Down Payment Gift: Buying a condo with "free" money from parents. * The Inheritance Tax Debate: Taking 20% to build schools for everyone.', img: 'topic_15_wealth_transfer_1777300527576.png'},
    {id: '9', title: 'The 4-Day Work Week: Rest or Risk?', curr: 'SCO 5.3', desc: '32 hours of work for 40 hours of pay. Happy workers or a lazy economy?', ex: 'The Microsoft Trial: A 40% jump in productivity from resting more. * The Global Gap: Losing contracts because the team was offline on Friday.', img: ''},
    ...
    {id: '12', title: 'The RTO War: Saving the City', curr: 'SCO 5.1', desc: 'Your boss says "office," you say "home." If offices stay empty, the cities die.', ex: 'The Mandatory Tuesday: Ordering workers back to save a ghost town. * The Commuter Rebellion: Workers quitting to join remote-only firms.', img: ''},
    {id: '13', title: 'The Free Ride: No Fares, No Problems?', curr: 'SCO 5.1', desc: 'Why isn’t the bus free? Some cities did it, but now they’re broke.', ex: 'The Luxembourg Model: Free transit for everyone paid by corporations. * Service vs. Price: Buses so dirty that everyone still drives a car.', img: ''},
    {id: '14', title: 'The Green Divide: NS Wind vs. US Coal', curr: 'SCO 5.2', desc: 'Nova Scotia is building offshore wind, but the U.S. just went back to coal.', ex: 'The Atlantic Loop: A $10B power line we can’t afford. * Industrial Flight: Factories moving to Maine for cheaper, dirtier power.', img: ''}
  ];
