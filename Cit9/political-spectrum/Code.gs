...
function migrateRosterToSheet() {
  var initialRoster = [
    ...
    {name:'Mohammad',    pin:'MJAF', party:'None',              partyid:'none',        role:'member'}
  ];
...
function fbGet(e) {
  ...
  if (!record) {
    ...
    Utilities.sleep(250);
    var sheet = getOrCreateSheet('FB_Feedback', FB_HEADERS);
    var rows = [
    ...
    ['Lachlan', 'The Niche Haligonians', 'Leader', 'FFAN',
      ...
      '4', 'You understood how budgets work.',
    ...
    ['Yunho', 'The Party De Solution', 'Member', 'T4N5',
      ...
      '3', 'You were honest about how voting works in practice.',
        'You did a great job explaining how social voting and personal connections drive elections in practice. For even more depth, you could have connected these observations to the formal structural layers and processes of Canadian government.',
    ...
    ['Clark', 'The Healthier Future', 'Member', '9F3K',
      '4', 'You thought about how issues are evaluated.',
      ...
      '4', 'You understood the gap between classroom and reality.',
    ...
    ['Nolan', 'The Niche Haligonians', 'Member', 'KFK6',
      ...
      '4', 'You supported the leader and contributed to the win.',
    ...
    ['Leo', 'Communist Party of Halifax', 'Member', 'RKKJ',
      '3+', 'You challenged other parties on their issues.',
        'You did a fantastic job interrogating other parties\' issue claims during the Town Hall with specific questions on renewable energy, sponsorship backup plans, and teacher funding. For even more depth, you could have worked to complete and lock in your own party\'s platform issues.',
        'What if the company gets exposed for something bad? (Town Hall question to Party De Solution)',
      '3', 'You thought about policy feasibility.',
        'You did a great job using Town Hall questions to probe the viability of other platforms, like teacher salary costs and renewable energy. For even more depth, you could have connected these questions to how Canadian government structures manage and allocate these resources.',
      ...
      '3+', 'You were one of the most active participants in the Town Hall.',
        'You did a great job engaging in the Town Hall with 6 submitted questions, including two selected for the stage. For even more depth, you could have worked to complete your own party\'s platform deliverables.',
        'If this sponsor thing goes wrong and they don\'t ever want to sponsor you, do you have a backup? (Town Hall question)',
      'Leo, your reflection was brief, but your actions during the Town Hall speak volumes. You submitted 6 questions during the Final Four debate -- the second-highest in the class. Two of your questions were selected for the stage. When your party\'s platform didn\'t get locked in, you didn\'t check out -- you leaned into the Town Hall and participated more actively than almost anyone else. That tells me you were paying attention the whole time, and you cared about the process even when your own party wasn\'t on stage.', false],
    ...
    ['Alia', 'The Unity Party', 'Member', 'LJFM',
      ...
      '3', 'You understood social dynamics in elections.',
        'You did a great job identifying the social dynamics of voting, observing that personal connections drive many outcomes. For even more depth, you could have connected these observations to the formal structures of Canadian government or policy-making processes.',
    ...
    ['Josie', 'Team Tomorrow', 'Member', 'MVQW',
      ...
      '3', 'You were honest about social voting.',
        'You did a great job identifying the potential pitfalls of social voting and friend-based electing. For even more depth, you could have explored how specific government structures or policies can help buffer against these popularity-driven outcomes.',
    ...
    ['Sarah', 'Equitable Rights Party', 'Member', '96EU',
      ...
      '4', 'You contributed to the work that mattered.',
    ...
    ['Kendra', 'Environmentalists at Work', 'Member', 'MTGG',
      '4', 'Your civic strategy covered the whole cycle.',
      ...
      '4', 'You supported your team where it counted.',
    ...
    ['Zankia', 'Environmentalists at Work', 'Member', 'CA3J',
      '4', 'Your party addressed real problems.',
      ...
      '3+', 'You distinguished classroom from reality.',
        'You did a great job distinguishing between popularity-driven classroom elections and policy-driven real-world elections. For even more depth, you could have connected this to the formal structures of the Canadian electoral system or specific government functions.',
      ...
      '4', 'You did the work that kept your party running.',
    ...
    ['Laila', 'Team Tomorrow', 'Leader', 'V4BC',
      ...
      '4', 'You named four funding streams, not one.',
      ...
      '4', 'You led with respect and clarity.',
    ...
    ['Farhan', 'Islamic Associations of Halifax', 'Leader', 'HRNH',
      '4', 'Your platform was the broadest and most ambitious.',
      ...
      '4', 'You broke down a real budget.',
    ...
    ['Abdul', 'Islamic Associations of Halifax', 'Member', 'ALZZ',
      ...
      '2+', 'Your reflection was brief.',
        'You did a great job being part of a team that developed a detailed tax budget breakdown. For even more depth, you could have expanded your reflection to share your personal insights on how government budgets and structures function.',
        'It will not be in the real life election will have about 3 m people.',
      '3', 'You tried to contribute, and that matters.',
    ...
    ['Ali', 'Halifax Climate Protection Party', 'Leader', 'D2ZD',
      '3', 'You set the issues for your party and challenged the others.',
        ...
        '',
      '3', 'Your Town Hall questions showed policy understanding.',
        'You did Y really well -- using Town Hall questions to probe policy trade-offs like ER staffing and transit overcrowding. For even more depth, you could have submitted a reflection and completed your own party\'s platform to demonstrate your understanding of government structures.',
    ...
    ['Kai', 'Halifax Climate Protection Party', 'Member', 'VFW8',
      '2+', 'Your party had real environmental issues.',
        'You did Y really well -- assisting with research, typing, and proposing neutral Town Hall questions to bridge parties. For even more depth, you could have worked to present your platform to the class.',
      ...
      '2+', 'Your reflection was honest but brief.',
        'You did Y really well -- observing the role candidate likability and energy play in voter interest. For even more depth, you could have connected these campaign dynamics to the formal structures of government.',
    ...
    ['Evie', 'The Equity Party', 'Leader', 'R7SX',
      '3+', 'Your platform had a clear philosophy.',
        ...
        '',
      '3', 'No reflection submitted.',
        'You did Y really well -- leading a party that built a philosophically distinct platform with clear funding ideas. For even more depth, you could have submitted a reflection to demonstrate your personal understanding of government structure.',
        '',
      '3+', 'Led a party with a clear direction.',
        'You did Y really well -- leading the Equity Party and establishing a platform with a clear identity. For even more depth, you could have submitted a reflection to share your individual perspective and contributions.',
        '',
    ...
    ['Isaac', 'Communist Party of Halifax', 'Member', 'ISAC',
      '2+', 'Limited evidence.',
        'You did Y really well -- participating in the election unit with the CPOH party. For even more depth, you could have submitted a reflection and worked with your team to fully complete the platform.',
        '',
      '2+', 'No reflection submitted.',
        'You did Y really well -- participating in the election unit as a member of CPOH. For even more depth, you could have submitted a reflection showing your understanding of government structure.',
        '',
      '2+', 'Limited evidence.',
        'You did Y really well -- participating as a member of CPOH. For even more depth, you could have submitted a reflection to share your contributions.',
        '',
    ...
    ['Brody', 'Communist Party of Halifax', 'Member', 'JY2P',
      '1', 'Limited evidence.',
        'You did Y really well -- participating in the unit as a member of the CPOH party. For even more depth, you could have engaged consistently with the platform issues and submitted a reflection.',
        '',
      '1', 'No evidence.',
        'You did Y really well -- registering as a member of the CPOH party. For even more depth, you could have participated consistently to explore how government structures work.',
        '',
      '1', 'Largely absent.',
        'You did Y really well -- registering as a member of CPOH. For even more depth, you could have participated consistently in the campaign.',
        '',
    ...
    ['Remy', 'The Party De Solution', 'Member', 'YMRP',
      '3', 'Your party had strong issues.',
        ...
        '',
      '3', 'No reflection submitted.',
        'You did Y really well -- contributing to the strong Party De Solution platform. For even more depth, you could have submitted a reflection to show your personal understanding of government structure.',
        '',
      '3', 'You challenged the opposition with a specific policy question.',
        'You did Y really well -- challenging the opposition with an on-stage question about the Coastal Protection Act. For even more depth, you could have submitted a reflection to document your overall engagement.',
    ...
    ['Huda', 'Team Tomorrow', 'Member', '6SUB',
      '2', 'Limited evidence.',
        ...
        '',
      '2', 'No evidence.',
        'You did Y really well -- participating in Team Tomorrow, which created a strong, well-structured platform. For even more depth, you could have submitted a reflection to show your personal understanding of government structure.',
        '',
      '2', 'No individual evidence.',
        'You did Y really well -- participating in the Team Tomorrow party. For even more depth, you could have submitted a reflection to detail your individual contributions.',
        '',
    ...
    ['Fatima', 'The Unity Party', 'Member', 'T6U2',
      '1', 'No evidence.',
        ...
        '',
      '1', 'No evidence.',
        'You did Y really well -- participating in the Unity Party, which created a platform covering transit, internships, and healthcare. For even more depth, you could have submitted a reflection to share your personal understanding of government structure.',
        '',
      '1', 'Party member, but role unclear.',
        'You did Y really well -- participating in the Unity Party. For even more depth, you could have submitted a reflection to detail your individual contributions.',
        '',
    ...
    ['Jana', 'The Equity Party', 'Member', 'TT8D',
      '3', 'Your party had a distinct platform.',
        ...
        '',
      '3', 'No evidence.',
        'You did Y really well -- participating in the Equity Party, which built a distinct platform. For even more depth, you could have submitted a reflection to share your personal understanding of government structure.',
        '',
      '3', 'Party member, but role unclear.',
        'You did Y really well -- participating in the Equity Party. For even more depth, you could have submitted a reflection to detail your individual contributions.',
        '',
    ...
    ['Mohammad', 'None', 'Member', 'MJAF',
      '1', 'No evidence.',
        'You were absent for this unit.',
        '',
      '1', 'No evidence.',
        'You were absent for this unit.',
        '',
      '1', 'Largely absent.',
        'You were absent for this unit.',
        '',
      'Mohammad, you were absent during this unit. Without participation, there is no evidence to assess. If there were circumstances that affected your attendance, please let me know.', false]
  ];
  ...
  SpreadsheetApp.flush();
  Logger.log('Wrote ' + rows.length + ' rows starting at row ' + startRow + '. All 31 students seeded.');
  }
  record = fbLookup(pin);
