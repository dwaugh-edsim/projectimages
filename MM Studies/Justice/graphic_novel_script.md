...
## PAGE 1: The Cold Front
* **Theme:** Survival and the desperate choice for shelter.
...
### Panel 1.2
* **Visual:** Liam crouches against a brick wall, one bar of battery on his phone. His mother's contact glows on the cracked screen. His thumb hovers over the call button — then pulls away.
* **Narration (Caption):** "The people who should catch you are sometimes the ones who were never caught themselves."
...
## PAGE 2: The Apprehension
* **Theme:** The entry of the state and humanizing the police response.
...
## PAGE 3: Actuarial Judgment
* **Theme:** The clinical assessment and labeling.
* **Layout:** Three panels (mixed layout).

### Panel 3.1
* **Visual:** Liam sits in a sterile booking room. A booking officer looks at a computer monitor and a clipboard.
* **Dialogue (Booking Officer):** "Address?"
* **Dialogue (Liam):** "I don't have one right now. I've been staying on couches."
...
* **Dialogue (Booking Officer):** "Under standard guidelines, you don't qualify for automatic release. You'll be held for court."

---

## PAGE 4: Echoes of Shubenacadie
...
## PAGE 5: The Product of the Court
* **Theme:** Punitive legal machinery and despair.
* **Layout:** Three horizontal panels.

### Panel 5.1
* **Visual:** Liam looks through cell bars at a harried duty counsel lawyer holding a stack of files.
* **Dialogue (Lawyer):** "It's a non-violent offense, but because you scored 'high risk' on housing, the Crown is pushing for jail time. They want to send a message."
* **Dialogue (Liam):** "I just wanted to get warm."

### Panel 5.2
* **Visual:** Symbolic conveyor belt fed with case folders, outputting uniform figures in orange jumpsuits.
* **Narration (Caption):** "The conventional court processes people like parts in a factory. It checks boxes, delivers sentences, and moves to the next file."

### Panel 5.3
* **Visual:** Liam sits alone in the cell after the lawyer leaves. He slumps against the wall, staring at the concrete floor. The fluorescent light buzzes overhead.
* **Narration (Caption):** "After the lawyer leaves, the silence is worse than the cold."
* **Dialogue (Liam - thought bubble):** *Maybe the checklist is right. Maybe I am what they say I am.*

---

## PAGE 6: The Medicine Pouch
* **Theme:** Culturally centered support and personal motivation.
* **Layout:** Three horizontal panels.

### Panel 6.1
* **Visual:** Claire, a Mi'kmaw elder from the MLSN network, sits across from Liam. She wears a beaded medallion. Her eyes carry a weight that isn't just professional.
* **Dialogue (Claire):** "Kwe', Liam. My name is Claire. I'm from the Mi'kmaw Legal Support Network."
* **Dialogue (Claire):** "I had a son who sat where you're sitting, fifteen years ago. Nobody showed up for him. I'm not letting that happen again."

### Panel 6.2
* **Visual:** Close-up of Claire placing a small, hand-crafted beaded medicine pouch on the table.
* **Dialogue (Claire):** "Your family comes from Sipeknekatik. You come from a community of caretakers, not a checklist."

### Panel 6.3
* **Visual:** Liam looks at the medicine pouch, his expression softening for the first time.
* **Dialogue (Liam - thought bubble):** *She sees me. Not the file — me.*

---

## PAGE 7: The Marshall Landmark
* **Theme:** Systemic history and wrongful conviction.
* **Layout:** Two vertical panels.

### Panel 7.1
* **Visual:** Claire shows Liam a pamphlet detailing Donald Marshall Jr.'s story.
* **Dialogue (Claire):** "In 1971, a Mi'kmaw teenager named Donald Marshall Jr. was wrongfully convicted in Nova Scotia. He spent 11 years in prison."
* **Fact Check Explainer (Interactive):** **Donald Marshall Jr.** — A Mi'kmaw youth wrongfully convicted of murder in Sydney, NS. The 1989 Royal Commission concluded that the system was plagued by systemic racism, leading to the creation of restorative justice initiatives in Nova Scotia.

### Panel 7.2
* **Visual:** Sepia-toned flashback of a young Donald Marshall Jr. walking out of court to a crowd of supporters.
* **Narration (Caption):** "The 1989 Royal Commission proved the system failed him simply because he was Mi'kmaw. It forced the province to face its systemic racism."
...
* **Dialogue (Liam):** "Bad day. But I'm still here."
