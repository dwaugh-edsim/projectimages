# Classroom Sim Architect: Knowledge Archive (v65.31 - synced with codebase)
...
<body>
    ...
    <script>
        ...
        function applyTheme() {
            ...
            document.getElementById('f-left').innerHTML = `${m.title || currentMission} | SITUATION ROOM PROTOCOL v65.31`;
