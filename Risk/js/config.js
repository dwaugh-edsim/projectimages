...
window.RISK_CONFIG = (function () {
  ...
  const TERRITORIES = {
    ...
    alaska:        { id:'alaska',        name:'Alaska',        continent:'northAmerica', cx:99,  cy:149,  cardType:'infantry' },
    northwest:     { id:'northwest',     name:'Northwest Terr.', continent:'northAmerica', cx:196, cy:152,  cardType:'cavalry' },
    greenland:     { id:'greenland',     name:'Greenland',     continent:'northAmerica', cx:394, cy:104,  cardType:'artillery' },
    alberta:       { id:'alberta',       name:'Alberta',       continent:'northAmerica', cx:184, cy:204,  cardType:'cavalry' },
    ontario:       { id:'ontario',       name:'Ontario',       continent:'northAmerica', cx:262, cy:213,  cardType:'artillery' },
    quebec:        { id:'quebec',        name:'Quebec',        continent:'northAmerica', cx:337, cy:212,  cardType:'infantry' },
    western_us:    { id:'western_us',    name:'Western US',    continent:'northAmerica', cx:175, cy:262,  cardType:'infantry' },
    eastern_us:    { id:'eastern_us',    name:'Eastern US',    continent:'northAmerica', cx:267, cy:276,  cardType:'cavalry' },
    central_america: { id:'central_america', name:'Central America', continent:'northAmerica', cx:199, cy:330, cardType:'artillery' },

    // ===== South America (4) =====
    venezuela:     { id:'venezuela',     name:'Venezuela',     continent:'southAmerica', cx:266, cy:384,  cardType:'infantry' },
    brazil:        { id:'brazil',        name:'Brazil',        continent:'southAmerica', cx:336, cy:446,  cardType:'cavalry' },
    peru:          { id:'peru',          name:'Peru',          continent:'southAmerica', cx:279, cy:470,  cardType:'artillery' },
    argentina:     { id:'argentina',     name:'Argentina',     continent:'southAmerica', cx:286, cy:555,  cardType:'infantry' },

    // ===== Europe (7) =====
    iceland:       { id:'iceland',       name:'Iceland',       continent:'europe', cx:435, cy:173,  cardType:'cavalry' },
    scandinavia:   { id:'scandinavia',   name:'Scandinavia',   continent:'europe', cx:510, cy:180,  cardType:'infantry' },
    ukraine:       { id:'ukraine',       name:'Ukraine',       continent:'europe', cx:575, cy:224,  cardType:'artillery' },
    great_britain: { id:'great_britain', name:'Great Britain', continent:'europe', cx:444, cy:238,  cardType:'cavalry' },
    northern_europe: { id:'northern_europe', name:'Northern Europe', continent:'europe', cx:496, cy:243,  cardType:'infantry' },
    western_europe: { id:'western_europe', name:'Western Europe', continent:'europe', cx:447, cy:298,  cardType:'artillery' },
    southern_europe: { id:'southern_europe', name:'Southern Europe', continent:'europe', cx:521, cy:289,  cardType:'cavalry' },

    // ===== Africa (6) =====
    north_africa:  { id:'north_africa',  name:'North Africa',  continent:'africa', cx:452, cy:379,  cardType:'infantry' },
    egypt:         { id:'egypt',         name:'Egypt',         continent:'africa', cx:529, cy:362,  cardType:'cavalry' },
    east_africa:   { id:'east_africa',   name:'East Africa',   continent:'africa', cx:569, cy:429,  cardType:'artillery' },
    congo:         { id:'congo',         name:'Congo',         continent:'africa', cx:528, cy:480,  cardType:'infantry' },
    south_africa:  { id:'south_africa',  name:'South Africa',  continent:'africa', cx:538, cy:570,  cardType:'cavalry' },
    madagascar:    { id:'madagascar',    name:'Madagascar',    continent:'africa', cx:604, cy:559,  cardType:'artillery' },

    // ===== Asia (12) =====
    ural:          { id:'ural',          name:'Ural',          continent:'asia', cx:668, cy:189,  cardType:'infantry' },
    siberia:       { id:'siberia',       name:'Siberia',       continent:'asia', cx:710, cy:152,  cardType:'cavalry' },
    yakutsk:       { id:'yakutsk',       name:'Yakutsk',       continent:'asia', cx:799, cy:146,  cardType:'artillery' },
    kamchatka:     { id:'kamchatka',     name:'Kamchatka',     continent:'asia', cx:897, cy:148,  cardType:'infantry' },
    irkutsk:       { id:'irkutsk',       name:'Irkutsk',       continent:'asia', cx:784, cy:204,  cardType:'cavalry' },
    afghanistan:   { id:'afghanistan',   name:'Afghanistan',   continent:'asia', cx:651, cy:260,  cardType:'artillery' },
    middle_east:   { id:'middle_east',   name:'Middle East',   continent:'asia', cx:601, cy:335,  cardType:'infantry' },
    india:         { id:'india',         name:'India',         continent:'asia', cx:702, cy:367,  cardType:'cavalry' },
    siam:          { id:'siam',          name:'Siam',          continent:'asia', cx:781, cy:398,  cardType:'artillery' },
    china:         { id:'china',         name:'China',         continent:'asia', cx:764, cy:321,  cardType:'infantry' },
    mongolia:      { id:'mongolia',      name:'Mongolia',      continent:'asia', cx:787, cy:262,  cardType:'cavalry' },
    japan:         { id:'japan',         name:'Japan',         continent:'asia', cx:882, cy:287,  cardType:'artillery' },

    // ===== Australia (4) =====
    indonesia:     { id:'indonesia',     name:'Indonesia',     continent:'australia', cx:815, cy:476,  cardType:'infantry' },
    new_guinea:    { id:'new_guinea',    name:'New Guinea',    continent:'australia', cx:904, cy:489,  cardType:'cavalry' },
    western_australia: { id:'western_australia', name:'Western Australia', continent:'australia', cx:832, cy:584,  cardType:'artillery' },
    eastern_australia: { id:'eastern_australia', name:'Eastern Australia', continent:'australia', cx:901, cy:552,  cardType:'infantry' },
  };
